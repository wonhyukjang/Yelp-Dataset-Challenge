...
write_csv('star2_resultPosDic.csv',resultPosArr)
write_csv('star2_resultNegDic.csv',resultNegArr)

write_csv('star2_resultPosReasonDic.csv',resultPosReasonArr)
write_csv('star2_resultNegReasonDic.csv',resultNegReasonArr)
