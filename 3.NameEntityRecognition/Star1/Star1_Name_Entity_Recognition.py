...
write_csv('star1_resultPosDic.csv',resultPosArr)
write_csv('star1_resultNegDic.csv',resultNegArr)

write_csv('star1_resultPosReasonDic.csv',resultPosReasonArr)
write_csv('star1_resultNegReasonDic.csv',resultNegReasonArr)
