...
write_csv('star3_resultPosDic.csv',resultPosArr)
write_csv('star3_resultNegDic.csv',resultNegArr)

write_csv('star3_resultPosReasonDic.csv',resultPosReasonArr)
write_csv('star3_resultNegReasonDic.csv',resultNegReasonArr)
