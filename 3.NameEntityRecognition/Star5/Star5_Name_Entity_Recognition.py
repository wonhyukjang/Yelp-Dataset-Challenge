...
write_csv('star5_resultPosDic.csv',resultPosArr)
write_csv('star5_resultNegDic.csv',resultNegArr)

write_csv('star5_resultPosReasonDic.csv',resultPosReasonArr)
write_csv('star5_resultNegReasonDic.csv',resultNegReasonArr)
